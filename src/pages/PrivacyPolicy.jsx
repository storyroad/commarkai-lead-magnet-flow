...
const PrivacyPolicy = () => (
  <div className="max-w-3xl mx-auto py-16 px-4 text-gray-200">
    ...
    <p>
      If you have any questions about this Privacy Policy, please email us at <a href="mailto:support@commarkai.com" className="text-blue-400 underline">support@commarkai.com</a>
    </p>
  </div>
);
